...
- The package version in this repo has since been bumped to `1.1.1`, but the runtime contract documented here still tracks the `1.0.43` behavior that the audited application depends on.
