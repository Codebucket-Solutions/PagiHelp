...
- This repository is now versioned as `2.2.0`, while the default export still preserves the `1.0.43` runtime contract that the audited application depends on.
